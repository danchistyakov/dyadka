...
import {$player, enterFullscreen, exitFullscreen, setMute, setPirate, setPlaying} from '@models/Player';
import {setNextEpisode, setPrevEpisode} from '@models/Playlist';
import {useEvent} from 'effector-react/ssr';
import ProgressBar from '@components/Players/components/DyadkaPlayer/components/ProgressBar';

const BottomControls: FC = () => {
    const {duration, isFullscreen, isMuted, isPlaying, progress, volume} = useStore($player)
    const [enterFullscreenFn, exitFullscreenFn, setPrevEpisodeFn, setNextEpisodeFn, setPlayingFn] = useEvent([enterFullscreen, exitFullscreen, setPrevEpisode, setNextEpisode, setPlaying]);
      ...
      <div className={styles.bottom_part}>
        ...
        <div className={styles.bottom_controls}>
          <div className={styles.bottom_left}>
            ...
            >
              {!remaining ? progress.playedFormatted
                : `-${formatTime(
