...
const Icons = (type) => {
  ...
  if (icon === "MenuIcon") {
    return (
      <svg {...type} width="5.5vw" fill="#fff" viewBox="0 0 24 24">
  ...
  if (icon === "CloseIcon") {
    return (
      <svg {...type} fill="#fff" focusable="false" viewBox="0 0 20 24">
        <path d="M7.707 6.293a1 1 0 00-1.414 1.414L10.586 12l-4.293 4.293a1 1 0 101.414 1.414L12 13.414l4.293 4.293a1 1 0 001.414-1.414L13.414 12l4.293-4.293a1 1 0 00-1.414-1.414L12 10.586 7.707 6.293z"></path>
      </svg>
    );
  }
