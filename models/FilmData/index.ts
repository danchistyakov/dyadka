...
export const $data = root.createStore<IMediaData | null>(null)
  .on(dataFx.doneData, (_, data) => data)

export const $kpId = root.createStore<number | null>(null)
  .on(dataFx.doneData, (_, data) => data.kpId)

export const $seasons = createStore<ISeason[]>([])
  .on(dataFx.doneData, (_, data) => data.playlist)

export const $translations = root.createStore<ITranslation[] | null>([])
  .on(dataFx.doneData, (_, data) => data.translations)

export const $translation = root.createStore<ITranslation | null>(null)
